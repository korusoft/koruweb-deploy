            ...
            >
              ...
              <div>
                ...
                <div className="flex gap-4">
                  ...
                  <a href="https://github.com/korusoft" className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600 hover:bg-[#243e85] hover:text-white transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
