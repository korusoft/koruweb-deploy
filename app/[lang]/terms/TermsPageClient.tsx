          ...
          >
              ...
              {sections.map((sectionKey, index) => (
                ...
                >
                  ...
                  <div className="text-gray-600 leading-relaxed pl-11">
                    <p className="mb-4">{t(`terms.sections.${sectionKey}.content`)}</p>
                    {(() => {
                      const items = t(`terms.sections.${sectionKey}.items`);
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="mailto:legal@korucode.com"
